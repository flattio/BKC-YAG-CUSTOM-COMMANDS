...
{{ if $args := .Args }}
{{ if hasRoleID 1176361199437361243 }}
...
{{ end }}
{{ end }}
{{/* Use Regex .* please otherwise it wont work, Having too many of these .* regex could cause it to cease function, 3 and below is the goal*/}}